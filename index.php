...
// O nome do arquivo a ser incluído (por exemplo, page/home.php)
    ...
    <script>
        ...
        tailwind.config = {
            theme: {
                extend: {
                    colors: {
                        'natugral-green': '#0c623dff', // Verde Principal
                        'natugral-brown': '#674d38ff', // Marrom Madeira
                        'natugral-yellow': '#FFC300', // Amarelo Mel
                        'natugral-light': '#f7f7e7ff', // Bege
                    },
                    fontFamily: {
